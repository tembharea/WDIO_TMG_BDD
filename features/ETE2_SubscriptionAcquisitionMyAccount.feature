Feature: ETE 2 Subscription Acquisition MyAccount
    ...
    Scenario: TC_07:User purchasing Digital Plus plan with credit card
        Given I launch login from homepage
    ...
    Scenario: TC_08:Verify the Entitlements of Digital Plus Subscriber in Salesforce
        When I launch Salesforce URL
        Then I login to Salesforce
        Then Close Opened tabs in salesforce
    ...
    Scenario: TC_09:Verify the status of the subscription in Salesforce
        When I launch Salesforce URL
        Then I login to Salesforce
        Then Close Opened tabs in salesforce
        And Enter the DigitalPlus ete2ame2 id in the search box
    ...
    Scenario: TC_09:Validate Digital Plus Subscriber User data in Zoura
        When I launch Zoura application
        Then Login to Zoura
    ...
    Scenario: TC_27:User purchasing Digital Plus plan with American Express Card
        Given I launch login from homepage
    ...
    Scenario: TC_28:Verify the status of the subscription in Salesforce
        When I launch Salesforce URL
        Then I login to Salesforce
    ...
    Scenario: TC_29:Verify the Entitlements of Digital Plus Subscriber in Salesforce
        When I launch Salesforce URL
        Then I login to Salesforce
        And Enter the DigitalPlus ete2ame id in the search box
        Then Open the Account Page
    ...
    Scenario: TC_30:Validate Digital Plus Subscriber User data in Zoura
        When I launch Zoura application
        Then Login to Zoura
        Then Search the subscription in Zuora for Digital Plus
        Then Validate the digital plus subs details in Zoura

    Scenario: TC_31:Validate Digital Plus Subscriber data in Piano
        Given User opens Piano URL
        When User logins to Piano account
        When Navigate to All Users page
        Then Enter Digital Plus user subscriber email in search box
