...
#     And   I fill in new digitaltest129_1 email
...
#     When  I click login-register button
#     When  Go to My Account page
#     When  Copy the bonus url for digitaltest129_1
#     Then  Click on Manage Your Details button
...
#     And  Enter digitaltest129_1 subscriber email in search box in piano
...
#     Given I open zuora
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest129_1
...
#     Given I launch login from homepage
#     And I fill in new bonus email digitaltest129_1
...
#     Then I login to Salesforce
#     Then Close Opened tabs in salesforce
#     And Enter the digitaltest129_1Bonus in the search box in SF
#     And Open the Account Page
#     Then Validate if digitaltest129_1Bonus has active subscription in SF
#     Then Close Opened tabs in salesforce

# Scenario: TC_A_08:Validate Bonus user Account number is generated in Zoura
#     Given I open zuora
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest129_1Bonus
#     Then In Zoura I validate that Subscription is active for digitaltest129_1Bonus
#     And I logout from Zuora
...
#     Then Open the Account Page
#     When User clicks on Details tab
#     Then Validate if digitaltest129_1 is cancelled
#     Then Close Opened tabs in salesforce
...
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest129_1
#     Then validate Cancellation details for digitaltest129_1 in zuora
#     And I logout from Zuora 

# Scenario: TC_A_12:Validate Bonus sub is working after Cancellation in Telegraph
#     Given I launch login from homepage
#     And   I fill in existing digitaltest129_1Bonus email
#     When  I click login-register button
#     And   I enter "valid" register password
#     When  I click login-register button
#     When  Go to My Account page
...
#     Given I launch login from homepage
#     And I fill in new digitaltest129_2 email
#     When I click login-register button
#     And I enter "valid" register password
#     Then I enter "right" first name and last name
#     When I click continue button on registration page
...
#     When I click login-register button
#     When Go to My Account page
#     When Copy the bonus url for digitaltest129_2
#     Then Click on Manage Your Details button
#     Then Validate Your Subscription section
#     Then Validate Your Payment section
#     When Go to My Account page
...
#     Then Open the Account Page
#     When User clicks on Details tab
#     Then Validate if digitaltest129_2 user has active subscription in salesforce
#     Then Close Opened tabs in salesforce
...
#     When User logins to Piano account
#     When Navigate to All Users page
#     And  Enter digitaltest129_2 subscriber email in search box in piano
#     Then Validate Registration date in Piano
#     Then Validate Piano UiD
#     Then Validate Access details in Piano
#     Then LogOut from Piano
...
#     Given I open zuora
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest129_2
#     Then In Zoura I validate that Subscription is active for digitaltest129_2
#     And I logout from Zuora

# Scenario: TC_B_06:Redeem Bonus account from donors bonus link
#     Given I launch login from homepage
#     And I fill in new bonus email digitaltest129_2
#     And I click login-register button
#     And I enter "valid" register password
#     And I enter "right" first name and last name
#     And I click continue button on registration page
#     And Validate HomePage
#     And Go to My Account page
#     And I open the digitaltest129_2Bonus URL
#     And I validate bonus subscription is not redeem
#     And I activate bonus subscription
#     And User completes Bonus Onboarding Journey
#     And Go to My Account page
...
#     Then I login to Salesforce
#     Then Close Opened tabs in salesforce
#     And Enter the digitaltest129_2Bonus in the search box in SF
#     And Open the Account Page
#     Then Validate if digitaltest129_2Bonus has active subscription in SF
#     Then Close Opened tabs in salesforce

# Scenario: TC_B_08:Validate Bonus user Account number is generated in Zoura
#     Given I open zuora
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest129_2Bonus
#     Then In Zoura I validate that Subscription is active for digitaltest129_2Bonus
#     And I logout from Zuora
...
#     Then Open the Account Page
#     When User clicks on Details tab
#     Then Validate if digitaltest129_2 Downsell offer is displayed salesforce
#     Then Close Opened tabs in salesforce
...
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest129_2
#     Then validate downgrade details for digitaltest129_2 in zuora
#     And I logout from Zuora

# Scenario: TC_B_12:Validate Bonus sub is working after Downsell offer claim in Telegraph
#     Given I launch login from homepage
#     And   I fill in existing digitaltest129_2Bonus email
#     When  I click login-register button
#     And   I enter "valid" register password
#     When  I click login-register button
#     When  Go to My Account page
