...
const DigitalPlussCustAlRegistrant = rnd6 + "digitlplsal@telegraph.co.uk";
...
const DigitalPlussCustMRegistrant =
  rndst6 + "loggedoutmonthtest@telegraph.co.uk";
...
Given("I launch login from homepage", async () => {
  ...
  const consentmsgoneIframe = await $(
    '//iframe[@title="SP Consent Messaghhghfhgfhgfhe"]'
  );
  await browser.pause(5000);
