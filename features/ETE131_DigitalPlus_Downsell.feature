...
Scenario: TC_A_13:Validate Bonus sub is working after Downsell offer claim in Telegraph
    Given I launch login from homepage
    And   I fill in existing digitaltest127_1Bonus email
    When  I click login-register button
    And   I enter "valid" register password
...
Scenario: TC_B_13:Validate Bonus sub is working after Downsell offer claim in Telegraph
    Given I launch login from homepage
    And   I fill in existing digitaltest127_1Bonus email
    When  I click login-register button
    And   I enter "valid" register password
