...
#     And   I fill in new digitaltest130_1 email
...
#     Given I launch login from homepage
#     And   I fill in existing digitaltest130_1 email
#     When  I click login-register button
#     And   I enter "valid" register password
#     When  I click login-register button
#     When  Go to My Account page
#     When  Copy the bonus url for digitaltest130_1
#     When  Copy the bonus url2 for digitaltest130_1
#     When  Copy the bonus url3 for digitaltest130_1
#     Then  Click on Manage Your Details button
...
#     And Enter the digitaltest130_1 in the search box of salesforce
#     Then Open the Account Page
#     When User clicks on Details tab
#     Then Validate if digitaltest130_1 user has active subscription in salesforce
#     Then Close Opened tabs in salesforce
...
#     And  Enter digitaltest130_1 subscriber email in search box in piano
...
#     Then In Zoura I validate that Subscription is active for digitaltest130_1
#     And I logout from Zuora 

# Scenario: TC_A_06:Redeem Bonus account from donors bonus link
#     Given I launch login from homepage
#     And I fill in new bonus email digitaltest130_1
...
#     And I open the digitaltest130_1Bonus URL
...
#     Given I launch login from homepage
#     And I fill in new bonus email digitaltest130_1_2
#     And I click login-register button
#     And I enter "valid" register password
#     And I enter "right" first name and last name
#     And I click continue button on registration page
#     And Validate HomePage
#     And Go to My Account page
#     And I open the digitaltest130_1_2Bonus URL
#     And I validate bonus subscription is not redeem
#     And I activate bonus subscription
#     And User completes Bonus Onboarding Journey
#     And Go to My Account page
...
#     Given I launch login from homepage
#     And I fill in new bonus email digitaltest130_1_3
#     And I click login-register button
#     And I enter "valid" register password
#     And I enter "right" first name and last name
#     And I click continue button on registration page
#     And Validate HomePage
#     And Go to My Account page
#     And I open the digitaltest130_1_3Bonus URL
#     And I validate bonus subscription is not redeem
#     And I activate bonus subscription
#     And User completes Bonus Onboarding Journey
#     And Go to My Account page
...
#     Then I login to Salesforce
#     Then Close Opened tabs in salesforce
#     And Enter the digitaltest130_1Bonus in the search box in SF
#     And Open the Account Page
#     Then Validate if digitaltest130_1Bonus has active subscription in SF
#     Then Close Opened tabs in salesforce

# Scenario: TC_A_10:Validate Bonus user Account number is generated in Zoura
#     Given I open zuora
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest130_1Bonus
#     Then In Zoura I validate that Subscription is active for digitaltest130_1Bonus
#     And I logout from Zuora
...
#     Then Open the Account Page
#     When User clicks on Details tab
#     Then Validate if digitaltest130_1 Downsell offer is displayed salesforce
#     Then Close Opened tabs in salesforce
...
#     Given I launch login from homepage
#     And I fill in new digitaltest130_2 email
#     When I click login-register button
#     And I enter "valid" register password
#     Then I enter "right" first name and last name
#     When I click continue button on registration page
...
#     Given I launch login from homepage
#     And I fill in existing digitaltest130_2 email
#     When I click login-register button
#     And I enter "valid" register password
#     When I click login-register button
#     When Go to My Account page
#     When Copy the bonus url for digitaltest130_2
#     When Copy the bonus url for digitaltest130_2_2
#     When Copy the bonus url for digitaltest130_2_3
#     Then Click on Manage Your Details button
#     Then Validate Your Subscription section
#     Then Validate Your Payment section
#     When Go to My Account page
...
# Scenario: TC_B_03:Validate Digital Plus Annual Sub bought via credit card details in Salesforce
#     When I launch Salesforce URL
#     Then I login to Salesforce
#     Then Close Opened tabs in salesforce
#     And Enter the digitaltest130_2 in the search box of salesforce
#     Then Open the Account Page
#     When User clicks on Details tab
#     Then Validate if digitaltest130_2 user has active subscription in salesforce
#     Then Close Opened tabs in salesforce

# Scenario: TC_B_04:Validate Digital Plus Annual Sub bought via credit card details in Piano
#     Given User opens Piano URL
#     When User logins to Piano account
#     When Navigate to All Users page
#     And  Enter digitaltest130_2 subscriber email in search box in piano
#     Then Validate Registration date in Piano
#     Then Validate Piano UiD
#     Then Validate Access details in Piano
#     Then LogOut from Piano
...
# Scenario: TC_B_05:Validate Digital Plus Subscriber Account number is generated in Zoura
#     Given I open zuora
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest130_2
#     Then In Zoura I validate that Subscription is active for digitaltest130_2
#     And I logout from Zuora

# Scenario: TC_B_06:Redeem Bonus account from donors bonus link
#     Given I launch login from homepage
#     And I fill in new bonus email digitaltest130_2
#     And I click login-register button
#     And I enter "valid" register password
#     And I enter "right" first name and last name
#     And I click continue button on registration page
#     And Validate HomePage
#     And Go to My Account page
#     And I open the digitaltest130_2Bonus URL
#     And I validate bonus subscription is not redeem
#     And I activate bonus subscription
#     And User completes Bonus Onboarding Journey
#     And Go to My Account page
...
#     Given I launch login from homepage
#     And I fill in new bonus email digitaltest130_2_2
#     And I click login-register button
#     And I enter "valid" register password
#     And I enter "right" first name and last name
#     And I click continue button on registration page
#     And Validate HomePage
#     And Go to My Account page
#     And I open the digitaltest130_2_2Bonus URL
#     And I validate bonus subscription is not redeem
#     And I activate bonus subscription
#     And User completes Bonus Onboarding Journey
#     And Go to My Account page
...
#     Given I launch login from homepage
#     And I fill in new bonus email digitaltest130_2_3
#     And I click login-register button
#     And I enter "valid" register password
#     And I enter "right" first name and last name
#     And I click continue button on registration page
#     And Validate HomePage
#     And Go to My Account page
#     And I open the digitaltest130_2_3Bonus URL
#     And I validate bonus subscription is not redeem
#     And I activate bonus subscription
#     And User completes Bonus Onboarding Journey
#     And Go to My Account page
...
#     Then I login to Salesforce
#     Then Close Opened tabs in salesforce
#     And Enter the digitaltest130_2Bonus in the search box in SF
#     And Open the Account Page
#     Then Validate if digitaltest130_2Bonus has active subscription in SF
#     Then Close Opened tabs in salesforce

# Scenario: TC_B_10:Validate Bonus user Account number is generated in Zoura
#     Given I open zuora
#     And Login to Zoura
#     When Go to Zoura Subscription Page for digitaltest130_2Bonus
#     Then In Zoura I validate that Subscription is active for digitaltest130_2Bonus
#     And I logout from Zuora
...
# Scenario: TC_B_12:Validate Digital Plus Annual Sub Downsell details in Salesforce
#     When I launch Salesforce URL
#     Then I login to Salesforce
#     Then Close Opened tabs in salesforce
#     And Enter the digitaltest130_2 in the search box of salesforce
#     Then Open the Account Page
#     When User clicks on Details tab
#     Then Validate if digitaltest130_2 Downsell offer is displayed salesforce
#     Then Close Opened tabs in salesforce
...
Scenario: TC_A_09:Validate User can claim downgrade offer
    Given I launch login from homepage
    And   I fill in existing digitaltest127_1 email
    When  I click login-register button
    And   I enter "valid" register password
...
Scenario: TC_A_10:Validate Digital Monthly Sub downgrade details in Salesforce
    When I launch Salesforce URL
    Then I login to Salesforce
    Then Close Opened tabs in salesforce
    And Enter the digitaltest127_1 in the search box of salesforce
...
Scenario: TC_A_11:Validate Digital Subscriber downgrade details in Zoura
    Given I open zuora
    And Login to Zoura
    When Go to Zoura Subscription Page for digitaltest127_1
...
Scenario: TC_A_12:Validate Bonus sub is working after downgrade offer claim in Telegraph
    Given I launch login from homepage
...
Scenario: TC_A_13:Validate Bonus sub is working after downgrade offer claim in Telegraph
    Given I launch login from homepage
    And   I fill in existing digitaltest127_1Bonus email
    When  I click login-register button
    And   I enter "valid" register password
...
Scenario: TC_A_14:Validate Bonus sub is working after downgrade offer claim in Telegraph
    Given I launch login from homepage
    And   I fill in existing digitaltest127_1Bonus email
    When  I click login-register button
    And   I enter "valid" register password
...
Scenario: TC_B_09:Validate User can claim downgrade offer
    Given I launch login from homepage
    And   I fill in existing digitaltest127_2 email
    When  I click login-register button
    And   I enter "valid" register password
...
Scenario: TC_B_10:Validate Digital Annual Sub downgrade details in Salesforce
    When I launch Salesforce URL
    Then I login to Salesforce
    Then Close Opened tabs in salesforce
    And Enter the digitaltest127_2 in the search box of salesforce
...
Scenario: TC_B_11:Validate Digital Subscriber downgrade details in Zoura
    Given I open zuora
    And Login to Zoura
    When Go to Zoura Subscription Page for digitaltest127_2
...
Scenario: TC_B_12:Validate Bonus sub is working after downgrade offer claim in Telegraph
    Given I launch login from homepage
...
Scenario: TC_B_13:Validate Bonus sub is working after downgrade offer claim in Telegraph
    Given I launch login from homepage
    And   I fill in existing digitaltest127_1Bonus email
    When  I click login-register button
    And   I enter "valid" register password
...
Scenario: TC_B_14:Validate Bonus sub is working after downgrade offer claim in Telegraph
    Given I launch login from homepage
    And   I fill in existing digitaltest127_1Bonus email
    When  I click login-register button
    And   I enter "valid" register password
